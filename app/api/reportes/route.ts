...
async function getReporteVerificaciones(searchParams: URLSearchParams) {
  ...
  const data = verificaciones.map((v) => ({
    ...
    "Generación": v.generacion || "",
    "RAM": v.ram || "",
    "Disco": v.disco || "",
    "Sistema Operativo": v.sistemaOperativo || "",
    ...
    "DNI Responsable": v.dniResponsableActual || "",
  ...
  return NextResponse.json({
    ...
    columnas: [
      ...
      "Tipo", "Dimensiones", "Otros",
      // Especificaciones técnicas (equipos de cómputo)
      "Procesador", "Generación", "RAM", "Disco", "Sistema Operativo",
      "Resultado", "Situación", "Estado Físico", "Ubicación SIGA", "Ubicación Real",
      "Responsable SIGA", "Usuario SIGA", "Responsable Real", "DNI Responsable",
      "Dependencia SIGA",
